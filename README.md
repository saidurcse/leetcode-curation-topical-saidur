...
## Contest Solution
* [Count Prefixes of a Given String](https://leetcode.com/contest/biweekly-contest-77/problems/count-prefixes-of-a-given-string/) [Solution.java](https://leetcode.com/problems/count-prefixes-of-a-given-string/discuss/1994990/Java-Solution)
* [Intersection of Multiple Arrays](https://leetcode.com/contest/weekly-contest-290/problems/intersection-of-multiple-arrays/) [Solution.java](https://leetcode.com/problems/intersection-of-multiple-arrays/discuss/1976940/java-easy-solution)
...
* [Maximum product subarray](https://leetcode.com/problems/maximum-product-subarray/) (medium) [Solution.java](https://github.com/saidurcse/LeetCode-Solutions-Saidur/blob/main/152_maximum-product-subarray-medium.java)
...
* [Subsets](https://leetcode.com/problems/subsets/) (medium) [Solution.java](https://github.com/saidurcse/LeetCode-Solutions-Saidur/blob/main/78_subsets-medium.java)
...
* [Binary search tree iterator](https://leetcode.com/problems/binary-search-tree-iterator/) (medium) **(implementation should be lazy)** [Solution.java](https://github.com/saidurcse/LeetCode-Solutions-Saidur/blob/main/173_binary-search-tree-iterator-medium.java)
* [Flatten nested list iterator](https://leetcode.com/problems/flatten-nested-list-iterator/) (medium) **(implementation should be lazy)** [Solution.java](https://github.com/saidurcse/LeetCode-Solutions-Saidur/blob/main/341_flatten-nested-list-iterator-medium.java)
* [Implement trie (prefix tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) (medium) [Solution.java](https://github.com/saidurcse/LeetCode-Solutions-Saidur/blob/main/208_implement-trie-prefix-tree-medium.java)
* [LRU cache](https://leetcode.com/problems/lru-cache) (medium) [Solution.java](https://github.com/saidurcse/LeetCode-Solutions-Saidur/blob/main/146_lru-cache-medium.java)
